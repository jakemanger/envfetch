...
To enable Google Earth Engine support using the `extract_gee` function, follow instructions of the `rgee` page [here](https://github.com/r-spatial/rgee#how-to-use).
