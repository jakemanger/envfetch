...
If you would like to extend the functionality of `envfetch`, you can access and
use the underlying functions that do caching, time repeating and extracting.
A guide to use these functions can be found [here](./docs/articles/using-internal-functions-of-envfetch.html).
