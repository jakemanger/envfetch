...
#'
#' The `time_rep` function is used by the `fetch` function internally. It
...
#'
#' @param interval A lubridate period indicating the time interval to repeat.
#' It should be positive, e.g. `lubridate::days(14)`.
#' @param n_start An integer indicating the number of steps before the original
#' datetime from which the interval should start repeating. Default is -1. Note
#' this is inclusive.
#' @param n_end An integer indicating the number of steps after the original
